...
print(" Time taken to execute method_1  {} times is {}".format(10, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(10, timeit.timeit(stmt=method_2,number= 5)))
print(divider)
input_10 = sort_tuples(gen_input(100))
print(" Time taken to execute method_1  {} times is {}".format(100, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(100, timeit.timeit(stmt=method_2,number= 5)))
print(divider)
input_10 = sort_tuples(gen_input(1000))
print(" Time taken to execute method_1  {} times is {}".format(1000, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(1000, timeit.timeit(stmt=method_2,number= 5)))
print(divider)
input_10 = sort_tuples(gen_input(10000))
print(" Time taken to execute method_1  {} times is {}".format(10000, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(10000, timeit.timeit(stmt=method_2,number= 5)))
print(divider)
input_10 = sort_tuples(gen_input(100000))
print(" Time taken to execute method_1  {} times is {}".format(100000, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(100000, timeit.timeit(stmt=method_2,number= 5)))
print(divider)
input_10 = sort_tuples(gen_input(1000000))
print(" Time taken to execute method_1  {} times is {}".format(1000000, timeit.timeit(stmt=method_1,number= 5)))
print(" Time taken to execute method_2  {} times is {}".format(1000000, timeit.timeit(stmt=method_2,number= 5)))
print(divider)